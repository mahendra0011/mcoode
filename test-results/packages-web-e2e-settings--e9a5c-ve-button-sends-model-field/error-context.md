...
- Name: packages\web\e2e\settings-models.spec.js >> Settings → Model settings (ApiKeysTab) >> save button sends model field
- Location: packages\web\e2e\settings-models.spec.js:117:3
