...
- Name: packages\web\e2e\settings-models.spec.js >> Settings → Model settings (ApiKeysTab) >> model selection with gradient border
- Location: packages\web\e2e\settings-models.spec.js:47:3
