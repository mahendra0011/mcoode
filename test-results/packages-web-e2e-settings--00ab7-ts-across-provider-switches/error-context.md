...
- Name: packages\web\e2e\settings-models.spec.js >> Settings → Model settings (ApiKeysTab) >> model selection persists across provider switches
- Location: packages\web\e2e\settings-models.spec.js:69:3
