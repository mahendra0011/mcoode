...
- Name: packages\web\e2e\chat-flow.spec.js >> AIChatPage → Slash Commands >> slash commands work in Chat tab (not just empty state)
- Location: packages\web\e2e\chat-flow.spec.js:87:3
