...
- Name: packages\web\e2e\chat-flow.spec.js >> AIChatPage → Mode Switching >> send button is disabled when input is empty
- Location: packages\web\e2e\chat-flow.spec.js:159:3
