...
- Name: packages\web\e2e\chat-flow.spec.js >> AIChatPage → Slash Commands >> slash command list contains expected commands
- Location: packages\web\e2e\chat-flow.spec.js:31:3
