...
- Name: packages\web\e2e\chat-flow.spec.js >> AIChatPage → Mode Switching >> tab navigation renders (Design, Chat, AI Code Agent)
- Location: packages\web\e2e\chat-flow.spec.js:113:3
