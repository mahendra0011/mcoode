...
- Name: packages\web\e2e\chat-flow.spec.js >> AIChatPage → Mode Switching >> Advanced Mode toggle switches between chat and agent mode
- Location: packages\web\e2e\chat-flow.spec.js:119:3
