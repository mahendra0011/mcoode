...
- Name: packages\web\e2e\settings-models.spec.js >> Settings → Model settings (ApiKeysTab) >> no hardcoded Z.ai promotion button in sidebar
- Location: packages\web\e2e\settings-models.spec.js:100:3
