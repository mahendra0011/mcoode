...
- Name: packages\web\e2e\chat-flow.spec.js >> Integration: Model selection flow >> selected model in Settings persists and reflects in chat ModelSelector
- Location: packages\web\e2e\chat-flow.spec.js:229:3
