...
- Name: packages\web\e2e\settings-models.spec.js >> Settings → Usage stats (UsageTab) >> usage stats shows loading state then data
- Location: packages\web\e2e\settings-models.spec.js:168:3
