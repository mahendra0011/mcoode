...
- Name: packages\web\e2e\settings-models.spec.js >> Settings → Usage stats (UsageTab) >> heatmap renders with real data
- Location: packages\web\e2e\settings-models.spec.js:199:3
