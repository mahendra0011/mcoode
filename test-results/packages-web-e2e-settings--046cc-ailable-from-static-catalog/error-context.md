...
- Name: packages\web\e2e\settings-models.spec.js >> Settings → Model settings (ApiKeysTab) >> all providers have models available from static catalog
- Location: packages\web\e2e\settings-models.spec.js:31:3
