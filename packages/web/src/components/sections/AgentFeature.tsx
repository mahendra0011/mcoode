...
// Served statically from /public/assets by both Vite and Next (Vite proxies
// /assets to its publicDir; Next serves /public). We avoid importing the .mp4
// as a module because Turbopack has no default loader for media files.
const robotVideo = '/assets/robot-video.mp4';
...
export function AgentFeature() {
  ...
  const { scrollYProgress } = useScroll({
    target: sectionRef,
    offset: ['start bottom', 'bottom top'] as any
  });
